# Contributing to composer-confirm-task

First and foremost, thank you! We appreciate that you want to contribute to composer-confirm-task, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for composer-confirm-task**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for composer-confirm-task:

- star the [project](https://github.com/jonschlinkert/composer-confirm-task)
- tweet your support for composer-confirm-task
...
- **version**: please note the version of composer-confirm-task are you using
...
[so]: http://stackoverflow.com/questions/tagged/composer-confirm-task